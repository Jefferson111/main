...
.. Test case: `delete 1` +
   Expected: First event is deleted from the list. Details of the deleted event shown by SGTravel.
...
.. Test case: `recommend itinerary between 21/04/20 and 25/09/20` +
   ...
   .. Other incorrect itinerary commands: `recommend between 21/04/20 and 25/09/20`, `recommend`, `recommend between and`, `recommend between`, `recommend and`, `recommend between and 12/12/21`, `recommend between 12/12/21 and` +
   Expected: Similar to previous
